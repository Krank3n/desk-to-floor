...
- **2026-08-25** `dangerouslyAllowBrowser: true` on the SDK client — React Native trips its browser check. Justified only by the single-user/own-key decision above; revisit together with it.
